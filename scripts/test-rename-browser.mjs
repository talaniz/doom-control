...
try{
 ...
 assert.deepEqual(errors,[]);console.log('PASS Chromium: rename/save/cancel/error/read-only/live update; Plan/Normal payload, settings preservation, active-turn lock, new task reset; admin prompt/stop; user read-only selection, forged-write denial, live SSE, pending approval, reload, logout, mobile width; no JS exceptions.');
}finally{
